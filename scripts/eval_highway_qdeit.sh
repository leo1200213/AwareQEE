...
python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --model_name_or_path "/work/u7946530/Deit_qae_quant_6_conf_0.7_bits_6_6_6_6_6_6_6_6_6_6_6_6"\
...
python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --dataset_name $DATASET \
    --output_dir ../outputs/$MODEL_TYPE/$DATASET/$PAPER_NAME/$EXIT_STRATEGY/ \
    --model_name_or_path "/work/u7946530/Deit_qae_quant_6_conf_1.0_bits_6_7_7_7_7_6_5_6_6_5_5_5"\
    --remove_unused_columns False \
    --backbone $BACKBONE \
    --exit_strategy $EXIT_STRATEGY \
    --do_train False \
...
python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --dataset_name $DATASET \
    --output_dir ../outputs/$MODEL_TYPE/$DATASET/$PAPER_NAME/$EXIT_STRATEGY/ \
    --model_name_or_path "/work/u7946530/Deit_qae_quant_6_conf_0.8_bits_6_7_7_7_6_6_5_6_5_5_5_7"\
    --remove_unused_columns False \
    --backbone $BACKBONE \
    --exit_strategy $EXIT_STRATEGY \
    --do_train False \
  ...
  python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --dataset_name $DATASET \
    --output_dir ../outputs/$MODEL_TYPE/$DATASET/$PAPER_NAME/$EXIT_STRATEGY/ \
    --model_name_or_path "/work/u7946530/Deit_qae_quant_6_conf_0.8_bits_6_7_7_7_6_5_5_6_6_5_5_7"\
    --remove_unused_columns False \
    --backbone $BACKBONE \
    --exit_strategy $EXIT_STRATEGY \
    --do_train False \
    ...
    --calibration_batch_size 4 \
    --calibration_steps 100 \
    --per_layer_bits "[6, 7, 7, 7, 6, 5, 5, 6, 6, 5, 5, 7]" \
  ...
  python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --dataset_name $DATASET \
    --output_dir ../outputs/$MODEL_TYPE/$DATASET/$PAPER_NAME/$EXIT_STRATEGY/ \
    --model_name_or_path "/work/u7946530/Deit_qae_quant_7_conf_0.8_bits_7_7_7_7_7_7_7_7_7_7_7_7"\
    --remove_unused_columns False \
    --backbone $BACKBONE \
    --exit_strategy $EXIT_STRATEGY \
    --do_train False \
...
python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --dataset_name $DATASET \
    --output_dir ../outputs/$MODEL_TYPE/$DATASET/$PAPER_NAME/$EXIT_STRATEGY/ \
    --model_name_or_path "/work/u7946530/Deit_qae_quant_7_conf_1.0_bits_7_8_8_8_8_7_6_7_7_6_6_6"\
    --remove_unused_columns False \
    --backbone $BACKBONE \
    --exit_strategy $EXIT_STRATEGY \
    --do_train False \
...
python -m torch.distributed.run --nproc_per_node=2 --master_port=29566 --nnodes=1 ../examples/run_highway_qdeit.py \
    ...
    --dataset_name $DATASET \
    --output_dir ../outputs/$MODEL_TYPE/$DATASET/$PAPER_NAME/$EXIT_STRATEGY/ \
    --model_name_or_path "/work/u7946530/Deit_quant_7_conf_0.8_bits_7_7_8_7_7_7_7_7_7_6_6_8"\
    --remove_unused_columns False \
    --backbone $BACKBONE \
    --exit_strategy $EXIT_STRATEGY \
    --do_train False \
