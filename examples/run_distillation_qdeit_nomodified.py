...
def main():
   ...
   # output_dir_name = f"Deit_quant_{quant_bits}_conf_{confidence}_bits_{per_layer_bits_str}"
    output_dir_name = f"Deit_qae_quant_{quant_bits}_conf_{confidence}_bits_{per_layer_bits_str}"
