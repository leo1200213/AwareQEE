...
class SwinConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        quant_bits=8,
        per_w_layer_bits=None,  
        per_a_layer_bits=None,  # New parameter for per-layer bits
        **kwargs
    ):
        ...
        self.per_w_layer_bits = per_w_layer_bits 
        self.per_a_layer_bits = per_a_layer_bits # Assign per-layer bits
